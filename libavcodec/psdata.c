...
static const float iid_par_dequant_default[] = {
...
static const float iid_par_dequant_fine[] = {
...
static const float * const iid_par_dequant[] = {
    iid_par_dequant_default, iid_par_dequant_fine
};
